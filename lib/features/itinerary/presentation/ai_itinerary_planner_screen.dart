...
class _AiItineraryPlannerScreenState extends State<AiItineraryPlannerScreen> {
  ...
  Future<void> _savePlan() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          _controller.errorMessage ?? context.l10n.unableToSaveItinerary,
        ),
      ),
    );
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  context.l10n.whyRouteExplanation,
                  style: TextStyle(
                ...
                Container(
                  ...
                  child: Text(
                    context.l10n.whyRouteEnnoiaNote,
                    style: TextStyle(
                      color: _PlannerColors.deepPurple,
                      fontSize: 14,
                      height: 1.35,
                        ...
                        return Center(
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 14),
                              Text(
                                context.l10n.creatingAiItinerary,
                      ...
                      if (plan == null) {
                        return _ErrorState(
                          message:
                              ...
                              context.l10n.unableToLoadItinerary,
      ...
      child: Stack(
        ...
        children: [
          ...
          Positioned(
            ...
            top: 186 * scale,
            child: Text(
              context.l10n.crowdAwareItinerary,
              maxLines: 1,
              overflow: TextOverflow.ellipsis,
              style: TextStyle(
                color: _PlannerColors.textSub,
              ...
              label: FittedBox(
                ...
                child: Text(
                  isGenerating
                      ...
                      : context.l10n.generateAiItinerary,
                  style: TextStyle(
                    fontSize: 16 * scale,
                    fontWeight: FontWeight.w900,
                  ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: FittedBox(
        fit: BoxFit.scaleDown,
        child: Text(
          _plannerSourceLabel(context, label),
          maxLines: 1,
          style: TextStyle(
      ...
      builder: (context, constraints) {
        ...
        final sourceButton = Align(
          ...
          child: TextButton.icon(
            ...
            label: Text(context.l10n.viewKtoData),
              ...
              child: Column(
                ...
                children: [
                  ...
                  _SourceDetailLine(
                    ...
                    value: plan.persistedPlanId ?? context.l10n.notPersisted,
                  ),
                  _SourceDetailLine(
                    label: 'source_note',
                    value: plan.sourceNote ?? context.l10n.noSourceNote,
                  ),
                  const SizedBox(height: 10),
                  for (final item in plan.items)
                    _SourceDetailLine(
                      label: item.placeName,
                      value: item.contentId ?? context.l10n.noKtoContentId,
                    ),
                ],
              ),
            ),
    ...
    return SizedBox(
      ...
      child: DecoratedBox(
        ...
        child: FilledButton.icon(
          ...
          label: Text(
            isSaving ? context.l10n.saving : context.l10n.saveThisPlan,
