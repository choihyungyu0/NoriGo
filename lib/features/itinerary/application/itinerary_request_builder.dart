...
class ItineraryRequestBuilder {
  ...
  static const defaultDestination = 'South Korea';
  ...
  static const defaultFoodNeeds = 'None';
  ...
  ItineraryRequest build({TripBasics? basics, InterestsAlerts? alerts}) {
    ...
    final preferredLanguage = _clean(
      basics?.preferredLanguage,
      defaultUserLanguage,
    );
    ...
    return ItineraryRequest(
      ...
      destination: _clean(basics?.destination, defaultDestination),
      ...
      foodNeeds: _clean(basics?.foodNeed, defaultFoodNeeds),
    );
  }
